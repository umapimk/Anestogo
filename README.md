...
## What changed in v0.63.2

v0.63.2 is a **safety and correctness release**. No new clinical content was
...
| Record | Dose | Stock | v0.60 showed | v0.63.2 shows |
|---|---|---|---|---|
...
## v0.63.2 safety hardening status
...
- Service-worker cache is versioned `v0632-r1` and uses cache-first/stale-while-revalidate for the same-origin app shell.
...
## v0.63.2 — Interactive Crisis Checklist
